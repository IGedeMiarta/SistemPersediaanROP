                             ...
                             <?php
                                ...
                                foreach ($keluar as $b) { ?>
                                 <tr>
                                     ...
                                     <td><?= $b->pegawai ?></td>
                                     <td>
                                         <a href="<?= base_url('pegawai/keluar_del/' . $b->kd_keluar) ?>" class="badge badge-danger" onclick="return confirm('Yakin Hapus?')"><i class="fas fa-trash"></i> Hapus</a>
                                     </td>
                                 </tr>
                             <?php } ?>
                         </tbody>
         ...
         <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLongTitle">Barang Keluar</h5>
