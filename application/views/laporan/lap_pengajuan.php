             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <?php
                        ...
                        ?>
                         <a class='btn btn-primary' target="_blank" href='<?php echo base_url() . 'report/pengajuan_cetak?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fa fa-print'></i> CETAK</a>
                     <?php
                        }
                        ?>
                 </div>
